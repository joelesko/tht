...
namespace tht5b03247af2ed4;
\o\Runtime::setNameSpace('pages/home.tht','tht5b03247af2ed4');
...
\o\v($u_t)->u_ok((u_form_validate("123") === "123"), "default id ok");
\o\v($u_t)->u_ok((u_form_validate("\$foo") === ""), "default id not ok");
...
function u_form_validate ($u_v, $u_type="")  {
 if (($u_type === "")) {
return \o\v(\o\Runtime::getModule(__NAMESPACE__, 'Web')->u_validate_input($u_v))["value"];
