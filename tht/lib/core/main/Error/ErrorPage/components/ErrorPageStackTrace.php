...
class ErrorPageStackTrace extends ErrorPageComponent {
    ...
    function get() {
        ...
        if ($this->error['trace']) {
            ...
            return $this->formatTrace($frames);
        }
    ...
    function insertErrorFrame($frames) {
        ...
        $lastPath = ErrorTextUtils::cleanPath($lastFrame['file']);
    ...
    function formatTrace($frames) {
        ...
        $firstLine = $this->out("<div class=\"tht-error-trace-heading\">Trace:</div>\n", "Trace:\n\n");
    ...
    function formatFilePath($phpFrame) {
        ...
        $filePath = ErrorTextUtils::cleanPath($phpFrame['file']);
    ...
    function formatArgs($phpFrame) {
        ...
        foreach ($phpFrame['args'] as $a) {
            ...
            $argLabel = Tht::module('Json')->formatOneLineSummary($argLabel, 70);
            $args []= $argLabel;
        }
