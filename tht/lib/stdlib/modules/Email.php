...
class u_Email extends OStdModule {
    ...
    private function getAuth() {
        ...
        // TODO: validate this when originally parsing the config file.
        $config->u_check(OMap::create([
            'host' => '',
    ...
    public function u_validate_email($email) {
        ...
        $val = Tht::module('Input')->u_validate_value('test', $email, 'email');
