...
class UrlTypeString extends OTypeString {
    ...
    function updateString() {
        ...
        if (isset($this->parts['hash']) && $this->parts['hash']) {
            if ($this->str == '/') { $this->str = ''; }  // Local anchor only
    ...
    function u_to_link($label, $params=null) {
    ...
    function u_append_slug($longText, $skipWords='') {
