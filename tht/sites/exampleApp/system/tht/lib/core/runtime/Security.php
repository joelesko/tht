...
class Security {
    ...
    // TODO: Unset all original arrays?  Will that inhibit PHP interop?
    ...
    static function validateRequestOrigin() {
        ...
        // Post will be checked via the Input module
    ...
    static function isRemoteOrigin() {
    ...
    // // Fetch policy using 'sec-fetch-*' headers
    // // https://web.dev/fetch-metadata/
    // static function validateRemoteOrigin() {

    //     $site = Tht::getPhpGlobal('headers', 'sec-fetch-site');

    //     if (!$site) {
    //         // TODO: Deny accept 'image'
    //         return;
    //     }
    ...
    //     // Remote site.  Only allow GET navigation.
    //     $mode = Tht::getPhpGlobal('headers', 'sec-fetch-mode');
    //     $dest = Tht::getPhpGlobal('headers', 'sec-fetch-dest');
    //     if ($mode == 'navigate' && $this->isGetRequest()) {
    //         if (!in_array($dest, ['object', 'embed'])) {
    //             return;
    //         }
    //     }
    ...
    static function validatePostRequest() {
        ...
        else if (Security::isRemoteOrigin()) {
