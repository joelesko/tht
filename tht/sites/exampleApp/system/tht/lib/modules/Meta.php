...
class u_Meta extends OStdModule {
    ...
    function u_no_template_mode () {
        ...
        return ONothing::create('Meta.noTemplateMode');
    }
    ...
    function u_admin_only () {
        ...
        return ONothing::create('Meta.adminOnly');
    }
    ...
    function u_no_web_mode () {
        ...
        return ONothing::create('Meta.noWebMode');
    }
    //
    ...
    function u_get_tht_version($digits = false) {

        return Tht::getThtVersion($digits);
    }
    ...
    function u_z_handle_inbound_telemetry() {
        ...
        $data = Tht::getPhpGlobal('xDangerRemote', '*');

        return ErrorHandler::handleInboundTelemetry($data);
    }
}
