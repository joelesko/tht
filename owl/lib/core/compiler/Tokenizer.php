...
class Tokenizer extends StringReader {
    ...
    function makeToken ($type, $value, $spaceMask=null) {
        ...
        Owl::devPrint($this->tokenPos[0] . ',' . $this->tokenPos[1] . "\t$type\t$value");
    }
    ...
    // Handle template function body as a special string, dipping back out into OWL
    ...
    function handleTemplate () {
        ...
        while (true) {
            ...
            if ($this->atEndOfFile()) {
                ...
                // One line of OWL code e.g. ':: let a = 1;'
                $this->addTemplateString($str);
